...
@mcp.tool()
def get_task(company_name: str, income_statement_markdown: str, balance_sheet_markdown: str) -> str:
    """
    Returns a prompt that has the income_statement and balance_sheet plugged into the prompt template 
    """
    return f""" 
